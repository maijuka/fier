...
class RedQueryParser(Parser):
    ...
    def _literal_(self):
        with self._choice():
            ...
            with self._option():
                self._constant_literal_()
                self.ast['constant_literal'] = self.last_node
            self._error('no available options')
    ...
    @rule_def
    def _constant_literal_(self):
        with self._group():
            self._constant_bangs_()
            self.ast['constant_bangs'] = self.last_node
